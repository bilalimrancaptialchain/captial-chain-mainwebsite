...
import {
  contactAccordionSectionVariants,
  contactAccordionHeaderVariants,
  contactAccordionContentVariants,
  contactFormFieldVariants,
  contactFormInputVariants,
  contactFormSubmitVariants,
  contactChevronVariants,
  contactViewport,
...
const ContactAccordion: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      variants={contactAccordionSectionVariants}
      initial="hidden"
      whileInView="visible"
      viewport={contactViewport}
    >
      <div className="max-w-6xl mx-auto">
        <div className="border-[0.5px] border-faq bg-[#041933] rounded-lg overflow-hidden">
          {/* Accordion Header */}
          <motion.div
            className="p-8 cursor-pointer flex items-center justify-between hover:bg-gray-750 transition-colors duration-200"
            onClick={() => setIsOpen(!isOpen)}
            variants={contactAccordionHeaderVariants}
            whileHover="hover"
          >
            ...
            <div className="ml-8">
              <motion.div
                variants={contactChevronVariants}
          ...
          <AnimatePresence>
            {isOpen && (
              <motion.div
                variants={contactAccordionContentVariants}
                initial="hidden"
                animate="visible"
                exit="hidden"
                className="overflow-hidden"
              >
                <div className="px-8 pb-8 border-t border-gray-600">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                          ...
                          >
                            ...
                            <div className="relative">
                              ...
                              <motion.input
                                ...
                                value={formData.name}
                                onChange={handleInputChange}
                                className="w-full ps-12 pe-4 py-3 bg-[#022143] font-display border-[0.5px] border-faq rounded-lg text-white placeholder-gray-400 focus:outline-none transition-colors"
                      ...
                      <motion.div variants={contactFormFieldVariants}>
                        ...
                        <motion.textarea
                          ...
                          onChange={handleInputChange}
                          rows={8}
                          className="w-full p-4 bg-[#022143] font-display border-[0.5px] border-faq rounded-lg text-white placeholder-gray-400 focus:outline-none transition-colors resize-none"
