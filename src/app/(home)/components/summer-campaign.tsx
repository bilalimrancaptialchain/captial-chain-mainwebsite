...
const SummerCampaign = () => {
  ...
  return (
    <section className="summer-campaign-section w-full flex items-center justify-center flex-col py-36 gap-14 px-5 relative bg-[#000A13]">
      <video
        autoPlay
        loop
        muted
      ...
      <div className="summer-campaign-header max-w-[827px] flex items-center justify-center flex-col gap-4 z-20">
      ...
      <div className="summer-campaign-description-container w-full max-w-6xl rounded-xl flex items-center justify-center flex-col gap-11 px-10 mt-16 pt-14 pb-9 z-20">
      ...
      <div
        className={`summer-campaign-steps-container w-full max-w-[1020px] flex items-center justify-center relative z-20`}
      >
        <div
